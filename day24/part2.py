    ...
    def print(self, pos, mybliz=None):
        def thingat(tpos):
            ...
            if mybliz:
                ...
                if tpos in self.bliz:
                   return self.bliz[tpos]
            return self.grid[tpos]
...
def main():
    ...
    print(f"min={blizzard.min} max={blizzard.max} start={blizzard.start} end={blizzard.end}")
    global curtime
    curtime = 0
